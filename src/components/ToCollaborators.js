      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-sm-8">
            <div
              className="d-flex flex-column align-items-center text-container justifyContent: 'space-between'"
              style={{ width: '100%', margin: '0 auto'}}
            >

              <h2 style={{ margin: '0em 0em 0em 0em' }}>To Collaborators, thank you</h2>
              <h5 style={{ margin: '0.5em 0em 1em 0em' }}>Motivation + Collaboration + Action</h5>
              <h5>Motivation</h5>
              <h6 style={{ margin: '0em 0em 0.5em 0em',color:"gray" ,fontWeight:"normal" }}>
                  This website was born in the year of clear vision, and I had a vivid dream that unfolded over the course of that period. {' '}
                  {showMoreMotivation ? (
                     <>
                  ...
                  <button
                    ...
                    style={{ border: "none", background: "none", color: "black", cursor: "pointer",textDecoration: "underline"}}
                  >
                ...
                <h5>Collaboration</h5>
                <h6 style={{ margin: '0em 0em 0.5em 0em',color:"gray",fontWeight:"normal" }}>Legend has it that imagination allows each individual to view our limited experiences with another angle, and compassionate with the others'. Every now and then, history rhymes with itself, similar news appears to be "globalized," and the parties involved are often not aware of themselves being enablers of the situation. 
                <br/> <br/>
